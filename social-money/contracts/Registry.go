...
func (_Registry *RegistryCaller) LegacyProposalsByIndex(opts *bind.CallOpts, hashIndex [32]byte) (RegistryStruct0, error) {
	var out []interface{}
...
//
// Solidity: function legacyProposalsByIndex(bytes32 hashIndex) view returns((address,string,string,uint256,uint256,address,address,uint8,uint8,uint8,bool))
func (_Registry *RegistrySession) LegacyProposalsByIndex(hashIndex [32]byte) (RegistryStruct0, error) {
...
//
// Solidity: function legacyProposalsByIndex(bytes32 hashIndex) view returns((address,string,string,uint256,uint256,address,address,uint8,uint8,uint8,bool))
func (_Registry *RegistryCallerSession) LegacyProposalsByIndex(hashIndex [32]byte) (RegistryStruct0, error) {
	return _Registry.Contract.LegacyProposalsByIndex(&_Registry.CallOpts, hashIndex)
}
